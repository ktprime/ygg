...
{
	/* RBTree */
	using RBTree = ygg::RBTree<RBTreeNode, ygg::RBDefaultNodeTraits<RBTreeNode>,
	                           BasicTreeOptions>;
	/* ZTree */
	...
	std::cout << "==== Path-Length Minimizing Tree ====\n";
	TreeDepthAnalyzer<AvgMinTree, AvgMinTreeNode> taavgmin(count, seed);
	taavgmin.run();
